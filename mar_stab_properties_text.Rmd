...
There is growing interest in the use of first-order vector autoregressive models in ecology where they are often referred to as multivariate autoregressive, or MAR(1), models\footnote{see Ives $et \ al$. 2003 $Ecol~Monogr$ 73:301–330}. In particular, MAR(1) models have been used to estimate interactions among various members in a food web and evaluate overall community stability.
...
Following Holmes $et~al$.\footnote{2012 $The~R~Journal$ 4:11-19}, I will refer to this form of the MAR(1) model as a MARSS model, where SS stands for state-space, and we drop the parenthetic lag-1 identifier for convenience.
...
Ives $et~al$.\footnote{1999 $Ecology$ 80:1405–1421} provide a means for assessing the expected long-term change in the density (biomass) of species $i$, $L_i$, within a community of $p$ total members, owing to the effect of some covariate $j$. Specifically,
...
The second method comes from Neubert $et~al$.\footnote{2009 $Ecology$ 90:2683–2688}, wherein reactivity is
