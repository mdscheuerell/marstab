...
Ives et al. (1999) provide a means for assessing the expected long-term change in the density (biomass) of species $i$, $L_i$, within a community of $p$ total members, owing to the effect of some covariate $j$. Specifically,
...
3. Negative values of $\mathbf{B}$ ($-1 < b_{ii} < 0$) result in a time series with a 2-point oscillation.
...
## Long-terms change in abundance

Next let's calculate yhe expected long-term changes in the densities of the L WA plankton community owing to the "environment" ($i.e.$, a cosine wave indicative of seasonal variation.
