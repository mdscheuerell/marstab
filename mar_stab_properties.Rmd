...
3. When $-1 < b_{i=j} < 0$ along the diagonal of $\mathbf{B}$ result in a time series with a 2-point oscillation (for these purposes, I will only consider cases with positive elements along the diagonal of $\mathbf{B}$).
...
cc <- subset(as.data.frame(lakeWAplanktonTrans),
             Year>=1981 & Year<=1985, select=Temp)
